				...
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<article class="post-grid mb-5">
							<a>
								<img src="img/.q1.jpeg" alt="" class="img-fluid w-100">
							</a>
							<span
								class="font-sm text-color letter-spacing text-uppercase post-meta font-extra">#AYUDANDOALOSPANELEROS</span>
							<h2 style="color: #000000;" class="mb-2 mt-2 post-title"><strong>Sobre Nosotros</strong>
							</h2>

							<div class="post-content mt-3" style="font-size: 17px; text-align:justify;">
								<p>Somos una plataforma de comercio electrónico dedicada a ayudar a los productores de
									panela en el campo a vender sus productos de manera directa y justa. Creemos en el
									valor del trabajo agrícola y nos comprometemos a brindarles a los campesinos una
									herramienta fácil de usar para conectarse con un mercado más amplio, eliminando
									intermediarios y garantizando que reciban un pago justo por su esfuerzo. A través de
									nuestra plataforma, los consumidores pueden adquirir productos frescos y de alta
									calidad, apoyando a las comunidades rurales y fomentando un comercio más equitativo
									y sostenible.</p>
						...
						<div class="row">
							<div class="col-lg-6">
								<article class="post-grid mb-5">
									...
									<h3 class="post-title mb-1 mt-2"> Ayudamos</h3>

									<div class="post-content mt-4">
										<p style="font-size: 15px; text-align:justify;">Gracias a nuestra plataforma de
											ecommerce, comprar productos derivados de la panela nunca ha sido tan fácil.
											Ofrecemos una experiencia de compra sencilla y segura, con envíos rápidos y
											atención personalizada. Sabemos que nuestros clientes buscan calidad, y por
											eso cada uno de los productos que ofrecemos ha pasado por estrictos
											controles para asegurar que conservan todas las propiedades nutritivas y el
											sabor inigualable de la panela.</p>
									</div>
								</article>
							</div>
							...
							<div class="col-lg-6">
								<article class="post-grid mb-5">
									<a class="post-thumb mb-4 d-block" href="blog-single.html">
										<img src="img/.q4.jpg" alt="" class="img-fluid">
									</a>
									<span
										class="font-sm text-color letter-spacing text-uppercase post-meta font-extra">Explore</span>
									<h3 class="post-title mb-1 mt-2">Que Ofrecemos</h3>

									<div class="post-content mt-4">
										<p style="font-size: 15px; text-align:justify;">En nuestra tienda online,
											brindamos una amplia gama de productos derivados de la panela, desde dulces
											tradicionales hasta polvos y jarabes, ideales para quienes buscan
											alternativas naturales al azúcar refinado. Creemos en el poder de lo natural
											y trabajamos para que cada compra contribuya no solo a tu bienestar, sino
											también al fortalecimiento de comunidades rurales que dependen de la
											producción de este valioso recurso</p>
									</div>
								</article>
							</div>
							...
							<div class="col-lg-6">
								<article class="post-grid mb-5">
									<h3 class="post-title mb-1 mt-2">Valores</h3>
							...
							<div class="sidebar-wrap mt-5 mt-lg-0">
								<div class="sidebar-widget about mb-5  p-3">
									<div class="about-author">
										<img src="img/.q2.webp" alt="" class="img-fluid">
									</div>
									<h4 class="mb-0 mt-4 text-center">Misión </h4>
									<p class=" text-center">Panevi</p>

									<p style="font-size: 17px; text-align:justify;">En Panevi, nuestra misión es ofrecer
										productos de panela de la más alta calidad, promoviendo un estilo
										de vida saludable y sostenible. Nos dedicamos a llevar a cada hogar la
										autenticidad y el sabor puro de
										la panela, cultivada de manera ética y responsable. A través de nuestra tienda
										virtual, buscamos conectar
										a los consumidores con los productores locales, fortaleciendo las comunidades
										rurales y fomentando
								...
								<div class="sidebar-widget about mb-5  p-3">
									<div class="about-author">
										<img src="img/.q3.jpg" alt="" class="img-fluid">
									</div>
									<h4 class="mb-0 mt-4 text-center">Visión </h4>
									<p class=" text-center">Panevi</p>

									<p style="font-size: 17px; text-align:justify;">En Panevi, aspiramos a ser líderes
										en el mercado de productos de panela, reconocidos por nuestra calidad,
										sostenibilidad y compromiso con la salud y el bienestar de nuestros clientes.
										Nos envisionamos como un puente entre los consumidores conscientes y los
										productores locales, promoviendo prácticas agrícolas sostenibles y justas que
										beneficien tanto a las personas como al medio ambiente. A través de la
										innovación y la educación, buscamos crear una comunidad global que valore y
										aprecie la pureza y los beneficios de la panela.</p>
									<img src="img/.q3.jpg" alt="" class="img-fluid">
								</div>
