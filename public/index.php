...
<body>
		...
		<div class="coontainer">
			<div class="row g-5 align-items-center">
				...
				<div class="col-lg-5">
					...
					<br>
					<br>
					<center><a class="btnn btn-success py-3 px-5 mt-2" href="quienes_somoss.php">Conocer más..</a></center>
				</div>
		...
		<div class="container">
			...
			<div class="container-categories">
				<div class="card-category category-propiedades " style="background-image: url('img/imagen4.jpg');">
					...
					<p>Propiedades</p>
					<a href="ver_mas.php" style="text-decoration: none;"><span>Ver más</span></a>
				</div>
	...
	<center><h1 class="section-title mb-4" style="color: black">Conoce la Panela y Nuestros Productos
	</h1></center>
		...
		<div class="row">
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					<img src="img/melcoo.jpg" class="card-img-top" alt="Panela Tradicional" style="border-radius: 15px 15px 0 0;">
					<div class="card-body">
						<h5 class="card-title" style="color: #1a3e14; text-align: center">Melcochas</h5>
						<p class="card-text" style="text-align: center; font-size: 14px;">Las melcochas de panela son dulces tradicionales, masticables y pegajosos, hechos calentando panela y mezclándola con ingredientes como coco.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
			...
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					<img src="img/aguapa.jpg" class="card-img-top" alt="Panela Granulada" style="border-radius: 15px 15px 0 0;">
					<div class="card-body">
						<h5 class="card-title" style="color: #1a3e14; text-align: center">Bebidas de panela</h5>
						<p class="card-text" style="text-align: center; font-size: 14px;">Las bebidas de panela son preparadas disolviendo panela en agua, a veces con saborizantes como limón o canela.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
									<i class="fas fa-shopping-cart"></i>
			...
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					<img src="img/panelitas.jpg" class="card-img-top" alt="Panela con Cacao" style="border-radius: 15px 15px 0 0;">
					<div class="card-body">
						<h5 class="card-title" style="color: #1a3e14; text-align: center">Panelitas</h5>
						<p class="card-text" style="text-align: center; font-size: 14px;">Las panelitas son pequeñas golosinas hechas a base de panela, a menudo enriquecidas con ingredientes adicionales como coco, leche o frutos secos.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
									<i class="fas fa-shopping-cart"></i>
			...
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					...
					<div class="card-body">
						...
						<p class="card-text" style="text-align: center; font-size: 14px;">Las cocadas de panela son dulces tradicionales elaborados con coco rallado y panela, con una textura suave y un delicioso sabor a coco caramelizado.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
									<i class="fas fa-shopping-cart"></i>
			...
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					...
					<div class="card-body">
						<h5 class="card-title" style="color: #1a3e14; text-align: center">Alfandoques</h5>
						<p class="card-text" style="text-align: center; font-size: 14px;">Los alfandoques de panela son dulces tradicionales colombianos hechos con panela tradicional, también conocida como papelón o raspadura.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
									<i class="fas fa-shopping-cart"></i>
			...
			<div class="col-md-2 mb-3">
				<div class="card product-card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
					<img src="img/dulce.jpg" class="card-img-top" alt="Café endulzado con panela" style="border-radius: 15px 15px 0 0;">
					<div class="card-body">
						<h5 class="card-title" style="color: #1a3e14; text-align: center">Dulces de café con panela</h5>
						<p class="card-text" style="text-align: center; font-size: 14px;">Los dulces de café con panela son un postre que combina la riqueza del café puro con la dulzura de dicha panela colombiana.</p>
						<div class="text-center">
							<a href="productos.php">
								<button style="background-color: #1a3e14; border-color: #1a3e14;" class="btn btn-success">
									<i class="fas fa-shopping-cart"></i>
	...
	<section class="container mt-5">
		<div class="row">
			<div class="col-12">
				<div class="card shadow-lg border-0">
					<div class="card-body">
						<center><h2 class="section-title mb-4" style="color: #275d1e; margin-right: 50px;">¡Únete a Nuestra Dulce Tradición! </h2></center>
