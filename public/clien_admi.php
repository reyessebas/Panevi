...
<svg style="display: none;">
    ...
    <section class="page-content">
        <section class="search-and-user">
                    <h1 style="font-size: 35px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;"><i>CLIENTES</i></h1>
...
<script>
    ...
    function changeProfilePic(event) {
        ...
        <hr>
        <br>
        <h2 style="font-size: 25px; color: green;">Clientes</h2><br>
        <hr>
        <?php
...
// Define la consulta SQL para seleccionar todos los campos de la tabla clientes.
$clientes_sql = "SELECT id_cliente, nombre, apellido, email, password, telefono, direccion FROM clientes";
// Ejecuta la consulta SQL y almacena el resultado en la variable $clientes_result.
$clientes_result = $conexion->query($clientes_sql);
...
if ($clientes_result->num_rows > 0) {
    ...
    echo "<thead><tr><th>ID Cliente</th><th>Nombre</th><th>Apellido</th><th>Email</th><th>Contraseña</th><th>Teléfono</th><th>Dirección</th></tr></thead>";
    echo "<tbody>";

    // Itera a través de las filas devueltas por la consulta.
    while ($clientes_row = $clientes_result->fetch_assoc()) {
        // Genera una fila de la tabla por cada cliente.
        echo "<tr>";
        echo "<td>" . $clientes_row["id_cliente"] . "</td>";
        echo "<td>" . $clientes_row["nombre"] . "</td>";
        echo "<td>" . $clientes_row["apellido"] . "</td>";
        echo "<td>" . $clientes_row["email"] . "</td>";
        echo "<td>" . $clientes_row["password"] . "</td>";
        echo "<td>" . $clientes_row["telefono"] . "</td>";
        echo "<td>" . $clientes_row["direccion"] . "</td>";
        echo "</tr>";
    }
    ...
    // Si no hay filas, muestra un mensaje indicando que no hay clientes disponibles.
