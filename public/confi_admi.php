...
<script>
    ...
    function changeProfilePic(event) {
        ...
        <hr>
        <br>
        <form method="post" style="max-width: 500px; margin: auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    <br>
        <h1 style="font-size: 25px; color: #275d1e; text-align: center;">Actualizar Información</h1>
    <br>
    <?php if (isset($mensaje)): ?>
    <center>
    <div style="color: <?= strpos($mensaje, 'correctamente') !== false ? 'green' : 'red' ?>; font-weight: bold; text-align: center; width: 80%; text-transform: uppercase; padding: 10px; border: 1px solid <?= strpos($mensaje, 'correctamente') !== false ? 'green' : 'red' ?>; border-radius: 5px; background-color: <?= strpos($mensaje, 'correctamente') !== false ? '#d4edda' : '#f8d7da' ?>; font-size: 14px;">
        <?= $mensaje ?>
    </div>
    </center>
    <?php endif; ?>
    <br>
    <center>
    <label for="nuevo_email" style="display: block; margin-bottom: 5px; text-align: center"><b>Nuevo Correo Electrónico</b></label>
    <input style="width: 85%; padding: 10px; border: 1px solid #ccc; border-radius: 20px; margin-bottom: 20px;" type="email" id="nuevo_email" name="nuevo_email">
    <label for="password_actual" style="display: block; margin-bottom: 5px; text-align: center"><b>Contraseña Actual</b></label>
    <input style="width: 85%; padding: 10px; border: 1px solid #ccc; border-radius: 20px; margin-bottom: 20px;" type="password" id="password_actual" name="password_actual">
    <label for="nueva_password" style="display: block; margin-bottom: 5px; text-align: center"><b>Nueva Contraseña</b></label>
    <input style="width: 85%; padding: 10px; border: 1px solid #ccc; border-radius: 20px; margin-bottom: 20px;" type="password" id="nueva_password" name="nueva_password">
    <input style="background-color: #275d1e; color: white; font-weight: bold; padding: 10px 15px; margin: 8px 0; cursor: pointer; width: 50%; border-radius: 20px; border: none; transition: background-color 0.3s ease, transform 0.3s ease;" 
