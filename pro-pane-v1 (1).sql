...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2024 a las 13:56:40
...
INSERT INTO `clientes` (`id_cliente`, `nombre`, `apellido`, `email`, `password`, `telefono`, `direccion`, `reset_token`, `reset_expiration`) VALUES
(1, 'Nini', 'Beltrán Cardenas', 'ninibeltran26@gmail.com', '122e41e1f73fdfb12bd2c4770f1b82f2', '3115461590', 'Villeta. Vereda chorrillo', '7036ba08f8aa4f45bc1d74c3b174302fb2b4e3a4bda2fcb18d4c5c3bb0480523', '2024-10-30 03:20:49');
...
(1, 1, 'Nini Johana cardenas', 'Vereda chorrillo', 'Villeta', '3115461590');
...
INSERT INTO `pedidos` (`id_pedido`, `id_cliente`, `id_detalle_pedido`, `fecha_pedido`, `fecha_envio`, `fecha_entrega`, `estado`, `total`) VALUES
(1, 1, 0, '2024-10-20', '2024-11-05', '0000-00-00', 'Entregado', 67800);
...
(3, 'Panela en Bolsa', 66000, 'imagenes_productos/3.jpg'),
(4, 'Panela Pulverizada', 7600, 'imagenes_productos/4.png'),
(5, 'Miel de Panela', 20800, 'imagenes_productos/5.jpeg'),
(6, 'Melcochas', 1500, 'imagenes_productos/6.jpg'),
(7, 'Panelitas', 1000, 'imagenes_productos/7.jpg'),
(8, 'Cocadas', 3700, 'imagenes_productos/8.jpg'),
(9, 'Alfandoques', 6000, 'imagenes_productos/9.jpg'),
(10, 'Dulces de Cafe', 1700, 'imagenes_productos/10.jpg');
